...
MAX_NT_ITER     = 1300;      % maximum IPM (Newton) iteration

% LINE SEARCH PARAMETERS
ALPHA           = 0.01;     % minimum fraction of decrease in the objective
BETA            = 0.5;      % stepsize decrease factor
MAX_LS_ITER     = 200;      % maximum backtracking line search iteration
...
% VARIABLE ARGUMENT HANDLING
t0         = min(max(1,1/min(lambda)),n/1e-3);
defaults   = {1e-5,false,1e-5,5000,ones(n,1),t0};
